import { Paper, createStyles, Title, Text, Anchor, List, ThemeIcon, ScrollArea } from "@mantine/core";
		...
		<div className={classes.mainContainer}>
			<div className={classes.wrapper}>
				...
				<img
					src={GraphIcon}
					width={70}
					className={classes.graphImg + " " + classes.shadowBox + " " + classes.circularIcons}
				/>
				...
				<Paper className={classes.form} radius={0} p={30}>
					...
					<Text align="center" mt="md">
						By starting you agree to our <CustomeLink label="terms and conditions" underline={true} />
					</Text>
				</Paper>
			</div>
		</div>
