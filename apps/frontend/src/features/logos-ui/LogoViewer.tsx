...
function LogoViewer(data: { setSelectLogo: any; selectLogo: any; imgs: Array<{ icon: string; name: string }> }) {
	...
	return (
		<Grid gutter="xs" columns={25}>
			{data.imgs.map((e, index) => {
				return (
					<Grid.Col lg={5} sm={8} xs={8} className={classes.imgBox} key={index}>
						<div
