...
const sourcesInfoData = [{ text: "Maneesha" }, { text: "Lakshani" }, { text: "ABCD" }, { text: "Maneesha Lakshani" }];
...
function ManageIntegrations() {
	...
	return (
		<div>
			<DashboardAccordion sourcesInfoData={sourcesInfoData} sourcesTypes={sourcesTypes} overrallWidth="100%" />
			<ConnectMoreDataSources sourcesTypes={sourcesTypes} InfoData={sourcesInfoData} overrallWidth="100%" />
		</div>
	);
}
