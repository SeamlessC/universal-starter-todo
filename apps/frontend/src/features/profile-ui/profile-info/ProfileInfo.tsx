import { ActionIcon, createStyles, FileButton, Grid, Group, Stack, Title } from "@mantine/core";
			...
			<Grid>
				...
				<Grid.Col span={12}>
					<Group position="apart" className={classes.btnsContainer}>
						<Btn label="Cancel" varient="subtle" textColor={theme.colors.orange[7]} />
						<Btn label="Save Changes" bgColor={theme.colors.orange[7]} textColor={theme.white} disabled={true} />
					</Group>
				</Grid.Col>
			</Grid>
		</form>
