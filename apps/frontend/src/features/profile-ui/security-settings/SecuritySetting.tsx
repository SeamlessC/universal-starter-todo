...
const AccessLogHeads = ["Date", "Dashboard", "IP Address", "Username", "Edit"];

const ipAccessHeads = ["Name", "Range Start", "Range End"];
	...
	return (
		<div>
			...
			<Center className={classes.marginTop}>
				<Btn label="Update Settings" btnWidth="35%" />
			</Center>
		</div>
	);
}
