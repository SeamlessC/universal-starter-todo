import { createStyles, Grid, Group, NavLink, Stack, Title, Burger, Drawer } from "@mantine/core";
			...
			<Grid className={classes.profileContainer}>
				<Grid.Col md={0} lg={3}>
					<Stack justify="space-between" className={classes.navContainer}>
						{data.map((item, index) => (
							<NavLink key={item.label} active={index === active} label={item.label} onClick={() => setActive(index)} />
						))}
					</Stack>
				</Grid.Col>
