import { Card, Center, Checkbox, createStyles, Divider, Grid, Text, Title } from "@mantine/core";
		...
		<div>
			<div className={classes.planContainer}>
				...
				<Center style={{ marginTop: "5%" }}>
					<Btn label="Change Plan" btnWidth="50%" />
				</Center>
				<BillingInfo />
				<Center className={classes.marginTop}>
					<CustomeLink label="Cancel Plan" underline={true} />
				</Center>
			</div>
		</div>
	);
