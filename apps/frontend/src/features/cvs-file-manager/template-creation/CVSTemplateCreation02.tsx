import { CloseButton, Divider, Grid, Group, Text } from "@mantine/core";
	...
	return (
		<Grid columns={48} justify="center">
			<Grid.Col sm={48} lg={17}>
				<Btn label="Add File" icon={PlusIcon} varient="outline" btnWidth="100%" />
			...
			<Grid.Col sm={48} lg={30} offset={1}></Grid.Col>
		</Grid>
	);
}
