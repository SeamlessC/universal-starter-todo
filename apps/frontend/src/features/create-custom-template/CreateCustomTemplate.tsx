					...
					<Grid.Col md={12} lg={8} order={1} orderSm={1} orderLg={1}>
						<div className={classes.background}>
							...
							<Text mt={20} fz="sm" className={classes.grayText}>
								eigh igaeg aiehg giahhegaegbaierg aeiurg aeiguae gaeiug eirgiaeurg eligerg whh aiehgliae gialeurgerg.
							</Text>
							<Text mt={15} fz="sm" className={classes.grayText}>
								rhie gaieurg aeirhgae gaeurg aeihga iae eg uegaeg aleug ueaghaeg aeirgiuae ier seiuhgae gege
								eiurhgaeirug iurhgi iregh;la giregh; iuhlj ibzdj srtihrth rhie gaieurg aeirhgae gaeurg aeihga iae eg
								uegaeg aleug ueaghaeg aeirgiuae ier seiuhgae gege eiurhgaeirug iurhgi iregh;la giregh; iuhlj ibzdj
								srtihrth
